...
namespace Emakio.GUI
{
    ...
    public class GUI
    {
        ...
        /// </summary>
        public List<Elements.AElement> Elements;
        ...
        {
            Elements = new List<Elements.AElement>();
        ...
        {
            foreach (Elements.AElement element in Elements)
                element.Update(time);
        }
        ...
        /// </param>
        public void RemoveElement(Elements.AElement element)
        {
        ...
        {
            foreach (Elements.AElement element in this.Elements)
                element.Initialize();
        }
    }
}
